...
function checkpoint() {
  if (vida == 0) {
    ...
    resetStatus(); // Resetando os status para o novo jogo
    ...
    if (check == "1" || check.toLowerCase() === "s") {
      ...
      if (escolha == "1") {
        executeCheckpoints(checkP); // Retorna ao último checkpoint
      } else if (escolha == "2") {
        ...
        if (numCheckpoint >= 1 && numCheckpoint <= 9) {
      ...
      function cap1() {
        ...
        if (escolha1 == "1" || escolha1.toLowerCase().includes("ficar")) {
          ...
          escolha1 == "2" ||
          escolha1.toLowerCase().includes("fugir")
        ) {
          alert(
      ...
      function cap2() {
        ...
        if (escolha2 == "1" || escolha2.toLowerCase().includes("dedicar")) {
          ...
          escolha2 == "2" ||
          escolha2.toLowerCase().includes("dividir")
        ) {
          alert(
      ...
      function cap3() {
        ...
        if (escolha3 == "1" || escolha3.toLowerCase().includes("tudo")) {
          ...
          escolha3 == "2" ||
          escolha3.toLowerCase().includes("cautela")
        ) {
          alert(
      ...
      function cap4() {
        ...
        if (escolha4 == "1" || escolha4.toLowerCase().includes("aceitar")) {
          ...
          escolha4 == "2" ||
          escolha4.toLowerCase().includes("recusar")
        ) {
          alert(
      ...
      function cap5() {
        ...
        if (escolha5 == "1" || escolha5.toLowerCase().includes("competir")) {
          ...
          escolha5 == "2" ||
          escolha5.toLowerCase().includes("cautela")
        ) {
          alert(
      ...
      function cap6() {
        ...
        if (escolha6 == "1" || escolha6.toLowerCase().includes("aceitar")) {
          ...
          escolha6 == "2" ||
          escolha6.toLowerCase().includes("recusar")
        ) {
          alert(
      ...
      function cap7() {
        ...
        if (escolha7 == "1" || escolha7.toLowerCase().includes("aceitar")) {
          ...
          escolha7 == "2" ||
          escolha7.toLowerCase().includes("recusar")
        ) {
          alert(
      ...
      function cap8() {
        ...
        if (escolha8 == "1" || escolha8.toLowerCase().includes("persistir")) {
          ...
          escolha8 == "2" ||
          escolha8.toLowerCase().includes("reduzir")
        ) {
          alert(
